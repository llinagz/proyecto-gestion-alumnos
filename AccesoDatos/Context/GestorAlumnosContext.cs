...
public partial class GestorAlumnosContext : DbContext
{
    public GestorAlumnosContext()
    {
    }

    public GestorAlumnosContext(DbContextOptions<GestorAlumnosContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LLINA\\SQLEXPRESS;Database=GestorAlumnos;Trust Server Certificate=true;User Id=udemy;Password=adminudemy;MultipleActiveResultSets=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FD19E1B97");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F478D14E8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FD33746A0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F93EB7790");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7F223CF9E");
